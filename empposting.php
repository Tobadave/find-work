        ...
        <div class="center" style="width: 250px; margin-left: -200px;">
            ...
            <div class="cont">
                ...
                <div class="background">
                    <div class="up">
                        <h1 style="color: rgb(0, 41, 0);">POST JOB TO FEED</h1>
                    </div>
                    <div class="down">
                        <form method="POST">
                        ...
                        <div>
                            ...
                            <input type="email" placeholder="Description fro your business">
                            
                            <label for="">Skill Needed</label>
                            <input type="text" placeholder="Skills are you in need of?...">
                            
                            <label for="">Location</label>
                            <input type="text" placeholder="Where's your company located?...">

                            <label for="">Salary</label>
                            <input type="number" placeholder="NGN">

                            <label for="">Deadline</label>
                            <input type="date" placeholder="">

                            <label for="">Resume Link</label>
                            <input type="text" inputmode="" placeholder="only accesible to job seekers" disabled>
